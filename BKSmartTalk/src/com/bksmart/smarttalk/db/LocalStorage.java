...
public class LocalStorage {
	...
	private LocalStorage(BKSmartApplication context){
	...
	public void insertMessage(ItemChat ic){
		lsDb.insertMessage(ic);
	}
	
	public ArrayList<ItemChat> getMessage(){
		return lsDb.getListMessage();
	}
	 ...
	 */
	public static LocalStorage create(BKSmartApplication app) throws StorageUnavailableException {
